...
/**
 * Created by guosen.lgs@alibaba-inc.com on 12/28/16.
 */
public class Base64 {
    ...
    /**
     * The 64 valid web safe B values.
     */
    ...
    /**
     * Translates a B value to either its 6-bit reconstruction value or a
     ...
     * resulting four B bytes to <var>destination</var>. The source and
    ...
    /**
     * Encodes a byte array into B notation. Equivalent to calling {@code encodeBytes(source, 0, source.length)}
     *
     * @param source
     *            The data to convert
     * @since 1.4
    ...
    /**
     * Encodes a byte array into web safe B notation.
     *
     * @param source
     *            The data to convert
     * @param doPadding
    ...
    /**
     * Encodes a byte array into B notation.
     *
     * @param source
     *            The data to convert
     * @param off
     ...
     *            the index where output will be put
     * @param decodabet
     *            the decodabet for decoding B content
    ...
    /**
     * Decodes data from web safe B notation. Web safe encoding uses '-'
    ...
    /**
     * Decodes B content in byte array format and returns the decoded byte
     * array.
     *
     * @param source
     *            The B encoded data
    ...
    /**
     * Decodes web safe B content in byte array format and returns the
    ...
    /**
     * Decodes B content using the supplied decodabet and returns the
     * decoded byte array.
     *
     * @param source
     *            The B encoded data
    ...
    public static byte[] decode(byte[] source, int off, int len, byte[] decodabet) throws Base64DecoderException {
        ...
        for (i = 0; i < len; i++) {
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) { // White space Equals sign or
                ...
                throw new Base64DecoderException("Bad B input character at " + i + ": " + source[i + off] + "(decimal)");
            }
        }
    ...
    public static class Base64DecoderException extends RuntimeException{
